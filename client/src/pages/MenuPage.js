    ...
    return (
        <div className="border p-4 mb-4">
            ...
            <div className="flex justify-end py-3">
                <button className="" onClick={handleRemoveFromCart} style={{background:'#EF4040',margin:'20px 0px', color: 'black'}}>Remove</button>
            </div>
        </div>
    );
};
            ...
            <div className='container'>
                <div className='row' style={{display:'flex', flexWrap:'wrap', justifyContent:''}} >
                    ...
                    <div className='col-md-3' style={{width:'200px'}}>
                        ...
                        <div className="container" >
                            <h2 style={{color: 'black'}}>Call Waiter for Help</h2>
                            <p style={{color: 'black'}}>Enter your table number to call the waiter:</p>
                            <input
                                type="number"
                                value={tableNumber}
                            ...
                            />
                            <button onClick={callWaiter} style={{marginTop:'10px', color: 'black'}}>Call Waiter</button>
                        </div>
                    </div>
                    <div className='col-md-6' style={{width:'900px'}}>
                        <h1 style={{ textAlign:'center', color: 'black'}}>Menu</h1>
                    ...
                    <div className='' >
                        <div className="App">
                            ...
                            <div style={{display:'flex', justifyContent:'space-between', flexWrap:'wrap'}}>
                                ...
                                <h4 style={{color: 'black'}}>Total: ${total.toFixed(2)}</h4>
                                <button onClick={handleOrder} style={{marginLeft: '20px', color: 'black'}}>Order</button>
                            </div>
                        </div>
                    </div>
                </div>
